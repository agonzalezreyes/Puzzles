...
class DynamicArrayTests(unittest.TestCase):
    ...
    def test_insert(self):
        keys = ["this", "is", "there", "answer", "any", "an"]
        for k in keys:
            self.t.insert(k)
        self.assertTrue(t.search("the") != False)
        self.assertTrue(t.search("is") == True)
        self.assertTrue(t.search("them") != False)
        self.assertTrue(t.search("any") == True)
...
class DynamicArrayTests(unittest.TestCase):
    ...
    def test_delete(self):
        ...
        self.arr.delete()
        self.assertEqual(str(self.arr), "[A]")
        self.arr.delete()
